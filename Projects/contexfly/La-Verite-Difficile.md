...
Généré et affiché intégralement par `analyse-approfondie`, après passage du sous-agent
`critique-produit` (regard adverse indépendant).
...
- [fonctionnalité/aspect] — pourquoi c'est vraiment différent, et **quels concurrents du
  benchmark ne le font PAS** (citation obligatoire : une affirmation non sourcée bascule
  automatiquement dans la liste ci-dessus)
